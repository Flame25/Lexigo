                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                ...
                                offset: Offset(
                                    0, 4), // Simulate bottom border by shadow
                                blurRadius: 0,
                                spreadRadius: 0,
                              ),
                            ],
                          ...
                          child: Stack(
                            ...
                            children: [
                              Positioned(
                                ...
                                right: 0,
                                bottom:
                                    4, // Create the effect of a solid bottom border
                                child: Container(
                                  decoration: BoxDecoration(
                              ...
                              Text(
                                'Start Study!'
                                    .toUpperCase(), // Text with uppercase
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  color: Colors.white, // Text color
                                  fontSize: 15, // Font size
                                  fontWeight:
                                      FontWeight.w900, // Bold font weight
                                  letterSpacing: 0.8, // Letter spacing
                                  fontFamily:
                                      'din-round', // Use custom font if available
                                ),
                              ),
                            ],
                          ),
